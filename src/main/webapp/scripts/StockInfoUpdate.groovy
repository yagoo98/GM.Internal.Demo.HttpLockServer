import com.google.gson.Gson
 ...
 //##變動 db / tableName / tableFields / updateFields##
 ...
 def updateFields =['stockId', 'stockDate', 'stockOpen', 'stockHigh', 'stockLow', 'stockClose', 'stockAdjClose', 'stockVol', 'updated', 'updateBy']
